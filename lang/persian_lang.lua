...
local function run(msg, matches)
	...
	set_text(LANG, 'welnew', 'متن خوش آمدگویی با موفقیت ذخیره شد')
       ...
       set_text(LANG, 'noEmojiT', 'استفاده از اموجی در این گروه ممنوع میباشد.')
        ...
        set_text(LANG, 'noVideoT', 'استفاده از ویدئو در این گروه ممنوع میباشد.')
        set_text(LANG, 'noVideoL', 'استفاده از ویدئو در این سوپر گروه ممنوع میباشد.')
        set_text(LANG, 'videoT', 'از این به بعد استفاده از ویدئو در این گروه آزاد است.')
        set_text(LANG, 'videoL', 'از این به بعد استفاده از ویدئو در این سوپر گروه آزاد است.')

         set_text(LANG, 'noInlineT', 'استفاده از پیام اینلاین در این گروه ممنوع میباشد.')
        set_text(LANG, 'noInlineL', 'استفاده از پیام اینلاین در این سوپر گروه ممنوع میباشد.')
        set_text(LANG, 'inlineT', 'از این به بعد استفاده از پیام اینلاین در این گروه آزاد است.')
        set_text(LANG, 'inlineL', 'از این به بعد استفاده از پیام اینلاین در این سوپر گروه آزاد است.')
        
          set_text(LANG, 'noOperatorT', 'استفاده از کلمات اپراتور در این گروه ممنوع میباشد.')
        set_text(LANG, 'noOperatorL', 'استفاده از کلمات اپراتور در این سوپر گروه ممنوع میباشد.')
        set_text(LANG, 'operatorT', 'از این به بعد استفاده از کلمات اپراتور در این گروه آزاد است.')
        set_text(LANG, 'operatorL', 'از این به بعد استفاده از کلمات اپراتور در این سوپر گروه آزاد است.')
      ...
      set_text(LANG, 'noFoshT', 'استفاده از فحش در این گروه ممنوع میباشد.')
        ...
        set_text(LANG, 'foshL', 'از این به بعد استفاده از فحش در این سوپر گروه آزاد است.')
	...
	set_text(LANG, 'tgservicesL', 'Telegram services allowed in this supergroup.')
		...
		set_text(LANG, 'tgservices', 'حذف پیام ورود و خروج')
        ...
        set_text(LANG, 'video', 'حذف خودکار ویدئو ها')
        set_text(LANG, 'inline', 'حذف پیام های اینلاین')
        set_text(LANG, 'operator', 'حذف خودکار اپراتور')
        ...
        set_text(LANG, 'tFlood', 'زمان  بررسی فلودینگ')
        set_text(LANG, 'setphoto', 'امکان عوض کردن عکس گروه')
    ...
    set_text(LANG, 'muteAll', 'توانایی صحبت از همه گرفته شد.')
       ...
       set_text(LANG, 'settings:20', '#settings tgservices enable/disable: وقتی فعال باشد هر کسی اموجی بفرستد ،تمامی اموجی هارا پاک خواهد کرد.')
       set_text(LANG, 'settings:21', '#settings fosh enable/disable : وقتی فعال باشد،هر کسی فحش بفرستد پیامش به صورت خودکار پاک میشود.')
         set_text(LANG, 'settings:22', '#settings emoji enable/disable : وقتی فعال باشد،هر کسی اموجی بفرستد،پیامش به صورت خودکار پاک میشود.')
