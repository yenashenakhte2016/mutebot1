...
local function run(msg, matches)
	if permissions(msg.from.id, msg.to.id, "lang_install") then
		...
		set_text(LANG, 'flood', 'Flood sensitivity')
		set_text(LANG, 'language', 'Language Bot')
		set_text(LANG, 'mFlood', 'Flood max')
		set_text(LANG, 'tFlood', 'Flood time')
		set_text(LANG, 'setphoto', 'Lock group photo')
        ...
        set_text(LANG, 'settings:21', '#settings emoji enable/disable: when disabled, all Emoji will be cleared.')
         set_text(LANG, 'settings:22', '#settings username enable/disable: when disabled, all Username will be cleared.')
         set_text(LANG, 'settings:2', '#settings tag enable/disable: when disabled, all Tag will be cleared.')
