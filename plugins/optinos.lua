...
local function check_member_super(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
	  local text = 'سوپرگروه با موفقیت ادد شد.'
...
local user_num = "تعداد اعضاها: "..result.participants_count.."\n"
local kicked_num = "تعداد افراد حذف شده: "..result.kicked_count.."\n"
local channel_id = "آیدی : "..result.peer_id.."\n"
if result.username then
	channel_username = "یوزرنیم شما: @"..result.username
else
	channel_username = ""
end
...
local function lock_group_operator(msg, data, target)
  ...
  if group_operator_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'operator has [@'..msg.from.username..'] been locked'
  end
end
...
local function unlock_group_operator(msg, data, target)
  ...
  if group_operator_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'operator has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function lock_group_emoji(msg, data, target)
  ...
  if group_emoji_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'emoji has [@'..msg.from.username..'] been locked'
  end
end
...
local function unlock_group_emoji(msg, data, target)
  ...
  if group_emoji_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'emoji has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function lock_group_tag(msg, data, target)
  ...
  if group_tag_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'tag has [@'..msg.from.username..'] been locked'
  end
end
...
local function unlock_group_tag(msg, data, target)
  ...
  if group_tag_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'tag has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function lock_group_links(msg, data, target)
  ...
  if group_link_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'Link posting has [@'..msg.from.username..'] been locked'
  end
end
...
local function unlock_group_links(msg, data, target)
  ...
  if group_link_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'Link posting has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function lock_group_media(msg, data, target)
  ...
  if group_media_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'media has [@'..msg.from.username..'] been locked'
  end
end
...
local function unlock_group_media(msg, data, target)
  ...
  if group_media_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'media has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function lock_group_username(msg, data, target)
  ...
  if group_username_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'username has [@'..msg.from.username..'] been locked'
  end
end
...
local function unlock_group_username(msg, data, target)
  ...
  if group_username_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'username has [@'..msg.from.username..'] been unlocked'
  end
end
 ...
 local function lock_group_video(msg, data, target)
  ...
  if group_video_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'Video posting has [@'..msg.from.username..']  been locked'
  end
end
...
local function unlock_group_video(msg, data, target)
  ...
  if group_Video_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'Video posting has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function unlock_group_etehad(msg, data, target)
  ...
  if group_etehad_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'normal has been unlocked'
  end
end
...
local function lock_group_normal(msg, data, target)
  ...
  local group_normal_lock = data[tostring(target)]['settings']['nornal']
  if group_normal_lock == 'yes' then
    return 'normal Settings is already locked'
  else
    data[tostring(target)]['settings']['nornal'] = 'yes'
    save_data(_config.moderation.data, data)
...
local function lock_group_bots(msg, data, target)
  ...
  if group_bots_lock == 'yes' then
    return 'bot telegram is already locked'
  else
    data[tostring(target)]['settings']['lock_bots'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'bot telegram has [@'..msg.from.username..'] been locked'
  end
end
...
local function unlock_group_bots(msg, data, target)
  ...
  if group_bots_lock == 'no' then
    return 'Bots telegram is not locked'
  else
    data[tostring(target)]['settings']['lock_bots'] = 'no'
    save_data(_config.moderation.data, data)
    return 'Bots telegram has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function lock_group_photos(msg, data, target)
  ...
  if group_photos_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'photos posting has [@'..msg.from.username..'] been locked'
  end
end
...
local function unlock_group_photos(msg, data, target)
  ...
  if group_photos_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'photos posting has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function lock_group_spam(msg, data, target)
  ...
  if group_spam_lock == 'yes' then
    return 'SuperGroup spam is [@'..msg.from.username..'] already locked'
  else
    data[tostring(target)]['settings']['lock_spam'] = 'yes'
    save_data(_config.moderation.data, data)
    return 'SuperGroup spam has [@'..msg.from.username..'] been locked'
  end
end
...
local function unlock_group_spam(msg, data, target)
  ...
  if group_spam_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'SuperGroup spam has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function lock_group_flood(msg, data, target)
  ...
  if group_flood_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'Flood has [@'..msg.from.username..'] been locked'
  end
end
...
local function unlock_group_flood(msg, data, target)
  ...
  if group_flood_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'Flood has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function lock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'Arabic has [@'..msg.from.username..'] been locked'
  end
end
...
local function unlock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'Arabic/Persian has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function lock_group_membermod(msg, data, target)
  ...
  return 'SuperGroup members has [@'..msg.from.username..'] been locked'
end
...
local function unlock_group_membermod(msg, data, target)
  ...
  if group_member_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'SuperGroup members has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function lock_group_rtl(msg, data, target)
  ...
  if group_rtl_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'RTL has [@'..msg.from.username..'] been locked'
  end
end
...
local function unlock_group_rtl(msg, data, target)
  ...
  if group_rtl_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'RTL has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function lock_group_join(msg, data, target)
  ...
  if group_join_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'join has [@'..msg.from.username..'] been locked'
  end
end
...
local function unlock_group_join(msg, data, target)
  ...
  if group_join_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'join has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function lock_group_number(msg, data, target)
  ...
  if group_number_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'number has [@'..msg.from.username..'] been locked'
  end
end
...
local function unlock_group_number(msg, data, target)
  ...
  if group_number_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'number has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function lock_group_ads(msg, data, target)
  ...
  if group_ads_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'ads has [@'..msg.from.username..'] been locked'
  end
end
...
local function unlock_group_ads(msg, data, target)
  ...
  if group_ads_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'ads has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function lock_group_tgservice(msg, data, target)
  ...
  if group_tgservice_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'Tgservice has [@'..msg.from.username..'] been locked'
  end
end
...
local function unlock_group_tgservice(msg, data, target)
  ...
  if group_tgservice_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'Tgservice has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function lock_group_fosh(msg, data, target)
  ...
  if group_fosh_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'fosh has [@'..msg.from.username..'] been locked'
  end
end
...
local function unlock_group_fosh(msg, data, target)
  ...
  if group_fosh_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'fosh has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function lock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'Sticker posting has [@'..msg.from.username..'] been locked'
  end
end
...
local function unlock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'Sticker posting has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function lock_group_fwd(msg, data, target)
  ...
  if group_fwd_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'fwd has [@'..msg.from.username..'] been locked'
  end
end
...
local function unlock_group_fwd(msg, data, target)
  ...
  if group_fwd_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'fwd has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function lock_group_english(msg, data, target)
  ...
  if group_english_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'english has [@'..msg.from.username..'] been locked'
  end
end
...
local function unlock_group_english(msg, data, target)
  ...
  if group_english_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'english has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function lock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'Contact posting [@'..msg.from.username..'] has been locked'
  end
end
...
local function unlock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'Contact posting has [@'..msg.from.username..'] been unlocked'
  end
end
...
local function enable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return 'Settings will be [@'..msg.from.username..'] strictly enforced'
  end
end
...
local function disable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return 'Settings will not [@'..msg.from.username..'] be strictly enforced'
  end
end
...
function show_supergroup_settingsmod(msg, target)
  ...
  local text = "تنظیمات سوپرگروه⚙⬇\n---------------------------------\n\nℹ️قفل لینک : "..settings.lock_link.."\nℹ️قفل عربی/فارسی : "..settings.lock_arabic.."\nℹ️قفل ادد ممبر : "..settings.lock_member.."\nℹ️حذف اعضا با اسم بلند: "..settings.lock_rtl.."\nℹ️قفل پیام ورود و خروج : "..settings.lock_tgservice.."\nℹ️قفل استیکر: "..settings.lock_sticker.."\nℹ️قفل ویدئو : "..settings.lock_video.."\nℹ️قفل عکس: "..settings.lock_photos.."\nℹقفل اپراتور: "..settings.operator.."\nℹقفل یوزرنیم (@): "..settings.username.."\nℹقفل مدیا : "..settings.media.."\n\nتنظیمات بیشتر⚙⬇\nℹقفل فحش: "..settings.fosh.."\nℹقفل ورود اعضای جدید: "..settings.join.."\nℹقفل پیام سریع : "..settings.flood.."\nℹقفل اسپم در گروه: "..settings.lock_spam.."\nℹقفل زبان انگلیسی: "..settings.english.."\nℹقفل متن فروراد شده: "..settings.fwd.."\nℹقفل ارسال اموجی: "..settings.emoji.."\nℹقفل ارسال تگ(#): "..settings.tag.."\nℹقفل ارسال عدد: "..settings.number.."\nℹقفل ارسال لینک پیشرفته: "..settings.ads.."\nℹقفل ورود ربات ها: "..settings.lock_bots.."\n\nسوییچ ها⚙⬇\n|>سوییچ  نرمال: "..settings.normal.."\n|>سوییچ اتحاد: "..settings.etehad
...
local function promote2(receiver, member_username, user_id)
  ...
  local member_tag_username = string.gsub(member_username, '@', '(at)')
  if not data[group] then
    return send_large_msg(receiver, 'سوپرگروه ادد نشده است.')
  end
  if data[group]['moderators'][tostring(user_id)] then
  ...
  data[group]['moderators'][tostring(user_id)] = member_tag_username
  save_data(_config.moderation.data, data)
  send_large_msg(receiver, member_username..' با موفقیت مدیر شد.')
end
...
local function demote2(receiver, member_username, user_id)
  ...
  if not data[group]['moderators'][tostring(user_id)] then
    return send_large_msg(receiver, member_tag_username..' مدیر نمیباشد.')
  end
  data[group]['moderators'][tostring(user_id)] = nil
  save_data(_config.moderation.data, data)
...
local function run(msg, matches)
	...
	local data = load_data(_config.moderation.data)
		...
		if matches[1] == 'newlink' and is_momod(msg)then
			...
			local receiver = get_receiver(msg)
				if success == 0 then
					send_large_msg(receiver, 'شما هنوز لینک را تنظیم نکرده اید،برای تنظیم لطفا /setlink را بفرستید')
		...
		if matches[1] == 'setlink' and is_owner(msg) then
			...
			save_data(_config.moderation.data, data)
			return 'لینک گروه را ارسال کنید'
		end
		...
		if msg.text then
			if msg.text:match("^(https://telegram.me/joinchat/%S+)$") and data[tostring(msg.to.id)]['settings']['set_link'] == 'waiting' and is_owner(msg) then
				...
				save_data(_config.moderation.data, data)
				return "لینک جدید با موفقیت تنظیم شد"
			end
		end
		...
		if matches[1] == 'link' then
			...
			if not group_link then
				return "شما لینک نساخته اید،برای ساخت لینک /newlink و یا /setlink را بفرستید"
			end
		...
		--[[if matches[1] == 'kick' and is_momod(msg) then
			...
			elseif matches[1] == 'setadmin' and matches[2] and not string.match(matches[2], '^%d+$') then
				...
				local username = matches[2]
				local username = string.gsub(matches[2], '@', '')
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] اددمین شد @"..username)
				resolve_username(username, callbackres, cbres_extra)]]
				local get_cmd = 'setadmin'
				local msg = msg
				local username = matches[2]
		...
		if matches[1] == 'demoteadmin' then
			...
			elseif matches[1] == 'demoteadmin' and matches[2] and not string.match(matches[2], '^%d+$') then
				...
				local username = matches[2]
				local username = string.gsub(matches[2], '@', '')
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] اددمین با موفقیت حذف شد @"..username)
				resolve_username(username, callbackres, cbres_extra)
			end
		end
		...
		--[[	local group_owner = data[tostring(msg.to.id)]['set_owner']
				if group_owner then
					...
					save_data(_config.moderation.data, data)
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] با موفقیت ["..matches[2].."] مدیر شد")
					local text = "[ "..matches[2].." ] مدیر شد."
					return text
				end]]
		...
		if matches[1] == 'promote' then
		  if not is_momod(msg) then
			...
			if not is_owner(msg) then
				return "فقط اددمین ها میتوانند استفاده کنند"
			end
			if type(msg.reply_id) ~= "nil" then
				local cbreply_extra = {
					get_cmd = 'promote',
			...
			elseif matches[1] == 'promote' and matches[2] and string.match(matches[2], '^%d+$') then
				...
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] مدیر شد user#id"..matches[2])
				user_info(user_id, cb_user_info, {receiver = receiver, get_cmd = get_cmd})
			elseif matches[1] == 'promote' and matches[2] and not string.match(matches[2], '^%d+$') then
				...
				local username = matches[2]
				local username = string.gsub(matches[2], '@', '')
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] مدیر شد @"..username)
		...
		if matches[1] == 'demote' then
			...
			if not is_owner(msg) then
				return "فقط اددمین ها و ساپورت ها میتوانند استفاده کنند"
			end
			if type(msg.reply_id) ~= "nil" then
				local cbreply_extra = {
					get_cmd = 'demote',
			...
			elseif matches[1] == 'demote' and matches[2] and string.match(matches[2], '^%d+$') then
				...
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] حذف شد user#id"..matches[2])
				user_info(user_id, cb_user_info, {receiver = receiver, get_cmd = get_cmd})
		...
		if matches[1] == "setabout" and is_momod(msg) then
			...
			return "متن درباره سوپرگروه با موفقیت تغییر کرد."
		end
		...
		if matches[1] == 'setrules' and is_momod(msg) then
			rules = matches[2]
			local target = msg.to.id
			savelog(msg.to.id, name_log.." ["..msg.from.id.."] قوانین گروه تغییر یافت\n ["..matches[2].."]")
		...
		if matches[1] == 'clean' then
			...
			if not is_momod(msg) then
				return "فقط مدیران میتوانند استفاده کنند"
			end
			if matches[2] == 'modlist' then
				if next(data[tostring(msg.to.id)]['moderators']) == nil then
					return 'هیچ مدیری در سوپرگروه وجود ندارد.'
				end
				for k,v in pairs(data[tostring(msg.to.id)]['moderators']) do
				...
				return 'تمامی مدیران پاک شدند'
			end
			if matches[2] == 'rules' then
				local data_cat = 'rules'
				if data[tostring(msg.to.id)][data_cat] == nil then
					return "قوانین ست نشده است."
				end
				data[tostring(msg.to.id)][data_cat] = nil
				save_data(_config.moderation.data, data)
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] تمامی قوانین پاک شدند.")
			...
			if matches[2] == 'about' then
				...
				data[tostring(msg.to.id)][data_cat] = nil
				save_data(_config.moderation.data, data)
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] با موفقیت متن درباره حذف شد")
				channel_set_about(receiver, about_text, ok_cb, false)
				return "هیچ متن درباره ای ثبت نشده است"
			end
			if matches[2] == 'mutelist' then
				chat_id = msg.to.id
				local hash =  'mute_user:'..chat_id
					redis:del(hash)
				return "کل افراد موته شده پاک شدند."
			end
			...
			if matches[2] == "bots" and is_momod(msg) then
				savelog(msg.to.id, name_log.." ["..msg.from.id.."] تمامی ربات های این سوپرگروه حذف شد")
       ...
       if matches[1] == 'unlock' and is_momod(msg) then
		...
		if matches[1] == "muteuser" and is_momod(msg) then
			...
			elseif matches[1] == "muteuser" and matches[2] and string.match(matches[2], '^%d+$') then
				...
				if is_muted_user(chat_id, user_id) then
					unmute_user(chat_id, user_id)
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] پاک شد ["..user_id.."] از لیست افراد موته")
					return "["..user_id.."] از لیست افراد موته شده حذف شد"
				elseif is_owner(msg) then
					mute_user(chat_id, user_id)
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] ادد شد  ["..user_id.."]  به لیست افراد موته.")
					return "["..user_id.."] به لیست افراد موته اضافه شد"
				end
